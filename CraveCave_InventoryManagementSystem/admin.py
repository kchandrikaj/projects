    ...
    def login(self, Event=None):
        ...
        if results:
            if results[0][6]=="Admin":
                ...
                img1 = PhotoImage(file='./images/0.png')
                adm.iconphoto(False, img1)
...
def inventory():
    ...
    page3 = Inventory(inv)
    page3.time()
    img1 = PhotoImage(file='dm.png')
    inv.iconphoto(False, img1)
